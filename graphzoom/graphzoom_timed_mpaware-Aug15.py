...
def main():
    ...
    parser.add_argument("--true_sage_super_dim", type=int, default=64,
                    help="Super-node embedding dimension for True Coarsened GraphSAGE")
    parser.add_argument("--true_sage_final_dim", type=int, default=64,
...
######Embed Reduced Graph######
    ...
    # In the embedding methods section:
        ...
        # Extract clusters from CMG projections (using ORIGINAL indices)
        ...
        print(f"✅ Extracted {len(clusters)} clusters from CMG")
        ...
        if n_nodes <= 50:  # Only for small graphs to avoid spam
